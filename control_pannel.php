...
<?php
    $possible_pages = ["home", "messages", "grid", "invites", "favoris"];
...
<html>
    ...
    <body>
        ...
        <nav id="desktop-control-nav" class="<?php echo isCustomer() ? '' : 'pouf' ?>">
            ...
            <a href="control_pannel.php?page=favoris" class="<?php echo $current_page == "favoris"? 'active-nav-item' : '' ?>"><img src="images/control_nav_pictos/picto_coeur.svg"><p>Mes&nbspfavoris</p></a>
